...
import { InputNomePlanta, InputQuantFrequencia } from "../../../../components/input";
...
export default function FormEditarPlantas({
  ...
  const { register, handleSubmit } = useForm<IFormPlanta>({
    defaultValues: {
      ...
      quant_frequencia: planta.quantidade_frequencia,
    },
  });
      ...
      const response = await fetch(
        `http://127.0.0.1:8000/api/planta/${planta.id}`,
        {
          ...
          body: JSON.stringify({
            ...
            quantidade_frequencia: dados.quant_frequencia,
          }),
        }
      );
